...
from model.debertaV2 import DebertaV2ForMaskedLM
...
PROMPT_MODELS = {
    "bert": {
        ...
        TaskType.LANGUAGE_MODELING: BertForMaskedLM
    },
    "roberta": {
        ...
        TaskType.LANGUAGE_MODELING: RobertaForMaskedLM
    },
    "albert": {
        TaskType.LANGUAGE_MODELING: AlbertForMaskedLM
    },
    "deberta": {
        TaskType.LANGUAGE_MODELING: DebertaV2ForMaskedLM
    },
    "xlnet": {
        TaskType.LANGUAGE_MODELING: XLNetLMHeadModel
    },
    "t5": {
        TaskType.LANGUAGE_MODELING: T5ForConditionalGeneration
    },
    "gpt2": {
        TaskType.LANGUAGE_MODELING: GPT2LMHeadModel
    },
    "deberta-v2": {
        TaskType.LANGUAGE_MODELING: DebertaV2ForMaskedLM
    }
...
def get_model(model_args, config: AutoConfig, fix_bert: bool = False):
    if model_args.prefix:
        ...
        if config.model_type == "deberta-v2" and model_args.fix_deberta:
            model.fix_layers()
            print("fix_deberta")
    else:
        # 直接fine-tune
