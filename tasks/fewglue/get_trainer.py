...
from tasks.fewglue.dataset import (
    FewGlueDataset
)
from training.trainer_base import BaseTrainer
from training.trainer_lm import LMTrainer
from training.trainer_DA import DATrainer
...
def get_trainer(args):
    ...
    if model_args.task_type == "sequence_classification":
        dataset = FewGlueDataset(tokenizer, model_args, data_args, training_args)
    elif model_args.task_type == "language_modeling":
        dataset = FewGlueDataset(tokenizer, model_args, data_args, training_args, config)
