...
_MRPC_DEV_IDS = "/home/sankuai/cephfs_caizefan/datasets/GLUE/MRPC/mrpc_dev_ids.tsv"
_MRPC_TRAIN = "/home/sankuai/cephfs_caizefan/datasets/GLUE/MRPC/msr_paraphrase_train.txt"
_MRPC_TEST = "/home/sankuai/cephfs_caizefan/datasets/GLUE/MRPC/msr_paraphrase_test.txt"
...
_MNLI_BASE_KWARGS = dict(
    ...
    data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/MNLI",
    data_dir="",
...
class Glue(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        GlueConfig(
            ...
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/CoLA",
            data_dir="CoLA",
            citation=textwrap.dedent(
                """\
        ...
        GlueConfig(
            ...
            label_column="label",
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/SST-2",
            data_dir="SST-2",
            citation=textwrap.dedent(
                """\
        ...
        GlueConfig(
            ...
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/QQP",
            data_dir="QQP",
            citation=textwrap.dedent(
                """\
          @online{WinNT,
        ...
        GlueConfig(
            ...
            label_column="score",
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/STS-B",
            data_dir="STS-B",
            citation=textwrap.dedent(
                """\
        ...
        GlueConfig(
            ...
            label_column="label",
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/QNLI",
            data_dir="QNLI",
            citation=textwrap.dedent(
                """\
        ...
        GlueConfig(
            ...
            label_classes=["entailment", "not_entailment"],
            label_column="label",
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/RTE",
            data_dir="RTE",
            citation=textwrap.dedent(
                """\
        ...
        GlueConfig(
            ...
            label_column="label",
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/WNLI",
            data_dir="WNLI",
            citation=textwrap.dedent(
                """\
        ...
        GlueConfig(
            ...
            data_url="/home/sankuai/cephfs_caizefan/datasets/GLUE/AX/AX.tsv",
            data_dir="AX",  # We are downloading a tsv.
    ...
    def _split_generators(self, dl_manager):
        ...
        if self.config.name == "mrpc":
            ...
            data_dir = os.path.join(self.config.data_url)
            mrpc_files = None
